...
async function getLabels() {
  return fetch(`https://api.github.com/repos/facebook/react/labels`, {
    headers: {
      Authorization: `Bearer ${process.env.REACT_APP_TOKEN}`,
    },
  }).then((res) => res.json());
...
class Issue extends Component {
  ...
  handleSubmit = async (event) => {
    ...
    fetch(
      `https://api.github.com/repos/facebook/react/issues/${issue.number}/comments`,
      {
        method: "POST",
        headers: {
  ...
  closeIssue = () => {
    ...
    fetch(
      `https://api.github.com/repos/facebook/react/issues/${issue.number}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
